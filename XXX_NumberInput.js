...
XXX_NumberInput.prototype.addPlusMinus = function ()
{
	...
	substractLink.href = '#';
	XXX_DOM.setInner(substractLink, '<img src="' + XXX_URI.currentHTTPServerProtocolPrefix + XXX_URI.staticURIPathPrefix + 'YAT/presenters/images/icons/black/minus.png" class="YAT_icon">');
	...
	addLink.href = '#';
	XXX_DOM.setInner(addLink, '<img src="' + XXX_URI.currentHTTPServerProtocolPrefix + XXX_URI.staticURIPathPrefix + 'YAT/presenters/images/icons/black/plus.png" class="YAT_icon">');
